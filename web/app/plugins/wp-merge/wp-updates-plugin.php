...
new WPUpdatesPluginUpdater_1992( 'http://wp-updates.com/api/2/plugin', plugin_basename(__FILE__) );
*/

if( !class_exists('WPUpdatesPluginUpdater_1992') ) {
    class WPUpdatesPluginUpdater_1992 {
