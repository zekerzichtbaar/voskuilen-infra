...
if (!\class_exists('WPMerge\\PluginUpdateChecker\\Puc_v4p11_Vcs_PluginUpdateChecker')) {
    class Puc_v4p11_Vcs_PluginUpdateChecker extends \WPMerge\PluginUpdateChecker\Puc_v4p11_Plugin_UpdateChecker implements \WPMerge\PluginUpdateChecker\Puc_v4p11_Vcs_BaseChecker
    {
        /**
        ...
        public function requestInfo($unusedParameter = null)
        {
            ...
            $info = new \WPMerge\PluginUpdateChecker\Puc_v4p11_Plugin_Info();
