...
if (!\class_exists('WPMerge\\PluginUpdateChecker\\Puc_v4p11_Vcs_ThemeUpdateChecker', \false)) {
    class Puc_v4p11_Vcs_ThemeUpdateChecker extends \WPMerge\PluginUpdateChecker\Puc_v4p11_Theme_UpdateChecker implements \WPMerge\PluginUpdateChecker\Puc_v4p11_Vcs_BaseChecker
    {
        /**
        ...
        public function requestUpdate()
        {
            ...
            $update = new \WPMerge\PluginUpdateChecker\Puc_v4p11_Theme_Update();
            ...
            $update->version = \WPMerge\PluginUpdateChecker\Puc_v4p11_Utils::findNotEmpty(array($remoteHeader['Version'], \WPMerge\PluginUpdateChecker\Puc_v4p11_Utils::get($updateSource, 'version')));
            //The details URL defaults to the Theme URI header or the repository URL.
            $update->details_url = \WPMerge\PluginUpdateChecker\Puc_v4p11_Utils::findNotEmpty(array($remoteHeader['ThemeURI'], $this->package->getHeaderValue('ThemeURI'), $this->metadataUrl));
