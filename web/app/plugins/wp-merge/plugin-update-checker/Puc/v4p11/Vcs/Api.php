...
if (!\class_exists('WPMerge\\PluginUpdateChecker\\Puc_v4p11_Vcs_Api')) {
    abstract class Puc_v4p11_Vcs_Api
    {
        ...
        public function getRemoteReadme($ref = 'master')
        {
            ...
            $parser = new \WPMerge\PluginUpdateChecker\PucReadmeParser();
        ...
        public function getRemoteChangelog($ref, $localDirectory)
        {
            ...
            return \WPMerge\PluginUpdateChecker\Parsedown::instance()->text($changelog);
        }
        /**
