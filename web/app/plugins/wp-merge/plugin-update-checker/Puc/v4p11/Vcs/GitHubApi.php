...
if (!\class_exists('WPMerge\\PluginUpdateChecker\\Puc_v4p11_Vcs_GitHubApi', \false)) {
    class Puc_v4p11_Vcs_GitHubApi extends \WPMerge\PluginUpdateChecker\Puc_v4p11_Vcs_Api
    {
        /**
        ...
        public function getLatestRelease()
        {
            ...
            $reference = new \WPMerge\PluginUpdateChecker\Puc_v4p11_Vcs_Reference(array(
            ...
            if (!empty($release->body)) {
                ...
                $reference->changelog = \WPMerge\PluginUpdateChecker\Parsedown::instance()->text($release->body);
            }
            return $reference;
        }
        /**
        ...
        public function getLatestTag()
        {
            ...
            $tag = $versionTags[0];
            return new \WPMerge\PluginUpdateChecker\Puc_v4p11_Vcs_Reference(array('name' => $tag->name, 'version' => \ltrim($tag->name, 'v'), 'downloadUrl' => $tag->zipball_url, 'apiResponse' => $tag));
        }
        /**
        ...
        public function getBranch($branchName)
        {
            ...
            $reference = new \WPMerge\PluginUpdateChecker\Puc_v4p11_Vcs_Reference(array('name' => $branch->name, 'downloadUrl' => $this->buildArchiveDownloadUrl($branch->name), 'apiResponse' => $branch));
