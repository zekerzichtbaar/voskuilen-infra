...
if (!\class_exists('WPMerge\\PluginUpdateChecker\\Puc_v4p11_Vcs_BitBucketApi', \false)) {
    class Puc_v4p11_Vcs_BitBucketApi extends \WPMerge\PluginUpdateChecker\Puc_v4p11_Vcs_Api
    {
        /**
        ...
        public function getBranch($branchName)
        {
            ...
            return new \WPMerge\PluginUpdateChecker\Puc_v4p11_Vcs_Reference(array('name' => $branch->name, 'updated' => $branch->target->date, 'downloadUrl' => $this->getDownloadUrl($branch->name)));
        }
        /**
         * Get a specific tag.
         *
        ...
        public function getTag($tagName)
        {
            ...
            return new \WPMerge\PluginUpdateChecker\Puc_v4p11_Vcs_Reference(array('name' => $tag->name, 'version' => \ltrim($tag->name, 'v'), 'updated' => $tag->target->date, 'downloadUrl' => $this->getDownloadUrl($tag->name)));
        }
        /**
        ...
        {
            $url = \ltrim($url, '/');
            $isSrcResource = \WPMerge\PluginUpdateChecker\Puc_v4p11_Utils::startsWith($url, 'src/');
        ...
        public function setAuthentication($credentials)
        {
            ...
            if (!empty($credentials) && !empty($credentials['consumer_key'])) {
                $this->oauth = new \WPMerge\PluginUpdateChecker\Puc_v4p11_OAuthSignature($credentials['consumer_key'], $credentials['consumer_secret']);
            } else {
                $this->oauth = null;
            }
        }
