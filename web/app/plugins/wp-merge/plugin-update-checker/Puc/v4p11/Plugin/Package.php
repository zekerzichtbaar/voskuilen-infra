...
if (!\class_exists('WPMerge\\PluginUpdateChecker\\Puc_v4p11_Plugin_Package', \false)) {
    class Puc_v4p11_Plugin_Package extends \WPMerge\PluginUpdateChecker\Puc_v4p11_InstalledPackage
    {
        /**
        ...
        public function isMuPlugin()
        {
            ...
            if ($cachedResult === null) {
                ...
                if ($muPluginDir === \false || $pluginPath === \false) {
                    ...
                    $pluginPath = \WPMerge\PluginUpdateChecker\Puc_v4p11_Factory::normalizePath($this->pluginAbsolutePath);
                }
