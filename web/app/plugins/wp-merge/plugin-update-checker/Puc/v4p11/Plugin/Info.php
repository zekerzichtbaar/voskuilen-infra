...
if (!\class_exists('WPMerge\\PluginUpdateChecker\\Puc_v4p11_Plugin_Info', \false)) {
    /**
     ...
     * @access public
     */
    class Puc_v4p11_Plugin_Info extends \WPMerge\PluginUpdateChecker\Puc_v4p11_Metadata
    {
