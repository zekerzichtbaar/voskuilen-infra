...
if (!\class_exists('WPMerge\\PluginUpdateChecker\\Puc_v4p11_UpdateChecker', \false)) {
    abstract class Puc_v4p11_UpdateChecker
    {
        ...
        public function __construct($metadataUrl, $directoryName, $slug = null, $checkPeriod = 12, $optionName = '')
        {
            ...
            $this->upgraderStatus = new \WPMerge\PluginUpdateChecker\Puc_v4p11_UpgraderStatus();
            $this->updateState = new \WPMerge\PluginUpdateChecker\Puc_v4p11_StateStore($this->optionName);
            if (\did_action('init')) {
                $this->loadTextDomain();
            } else {
         ...
         */
        protected function fixSupportedWordpressVersion(\WPMerge\PluginUpdateChecker\Puc_v4p11_Metadata $update = null)
        {
        ...
        {
            if (\class_exists('WPMerge\\PluginUpdateChecker\\Debug_Bar', \false) && \file_exists(\dirname(__FILE__) . '/DebugBar')) {
                $this->debugBarExtension = $this->createDebugBarExtension();
            }
        }
        protected function createDebugBarExtension()
        {
            return new \WPMerge\PluginUpdateChecker\Puc_v4p11_DebugBar_Extension($this);
        }
        /**
