...
if (!\class_exists('WPMerge\\PluginUpdateChecker\\Puc_v4p11_Theme_UpdateChecker', \false)) {
    class Puc_v4p11_Theme_UpdateChecker extends \WPMerge\PluginUpdateChecker\Puc_v4p11_UpdateChecker
    {
        ...
        {
            return new \WPMerge\PluginUpdateChecker\Puc_v4p11_Scheduler($this, $checkPeriod, array('load-themes.php'));
        }
        /**
        ...
        {
            return new \WPMerge\PluginUpdateChecker\Puc_v4p11_DebugBar_Extension($this, 'Puc_v4p11_DebugBar_ThemePanel');
        }
        /**
        ...
        {
            return new \WPMerge\PluginUpdateChecker\Puc_v4p11_Theme_Package($this->stylesheet, $this);
        }
    }
}
