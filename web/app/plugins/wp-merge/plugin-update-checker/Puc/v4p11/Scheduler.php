...
if (!\class_exists('WPMerge\\PluginUpdateChecker\\Puc_v4p11_Scheduler', \false)) {
    /**
    ...
    class Puc_v4p11_Scheduler
    {
        ...
        )
        {
            ...
            if (\is_a($this->updateChecker, 'WPMerge\\PluginUpdateChecker\\Puc_v4p11_Theme_UpdateChecker')) {
            ...
            if (\is_a($this->updateChecker, 'WPMerge\\PluginUpdateChecker\\Puc_v4p11_Plugin_UpdateChecker')) {
