...
if (!\class_exists('WPMerge\\PluginUpdateChecker\\Puc_v4p11_DebugBar_Extension', \false)) {
    class Puc_v4p11_DebugBar_Extension
    {
        ...
        private function getLibraryUrl($filePath)
        {
            ...
            $absolutePath = \WPMerge\PluginUpdateChecker\Puc_v4p11_Factory::normalizePath($absolutePath);
            $pluginDir = \WPMerge\PluginUpdateChecker\Puc_v4p11_Factory::normalizePath(\WP_PLUGIN_DIR);
            $muPluginDir = \WPMerge\PluginUpdateChecker\Puc_v4p11_Factory::normalizePath(\WPMU_PLUGIN_DIR);
            $themeDir = \WPMerge\PluginUpdateChecker\Puc_v4p11_Factory::normalizePath(\get_theme_root());
