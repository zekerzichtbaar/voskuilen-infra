...
//Fallback functions - wpmerge code addition
...
class wpdb {
	...
	function _real_escape( $string ) {
		...
		//return $this->add_placeholder_escape( $escaped );//wpmerge change
		return $escaped;//wpmerge change
	}
	...
	public function prepare( $query, $args ) {
		...
		//return $this->add_placeholder_escape( $query );//wpmerge change
		return $query;
	}
