...
class TextImage extends Block
{
    ...
    public $description = 'A simple Text Image block.';
    ...
    public function with()
    {
        return [
          ...
          'two_column_image_one'    => get_field('two_column_image_one'),
          'two_column_image_two'    => get_field('two_column_image_two'),
    ...
    {
        $acfFields = new FieldsBuilder('TextImage');
