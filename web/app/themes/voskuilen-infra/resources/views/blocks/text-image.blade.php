<section class="relative {{ $pt }} {{ $pb }}">
    @if($links && in_array('links', $content_items))
        <svg class="absolute -z-10 inset-y-0 left-0 h-full w-full lg:w-[70%] text-offwhite" xmlns="http://www.w3.org/2000/svg" width="auto" height="full"><rect width="1110" height="1075" fill="currentColor" fill-rule="evenodd"/></svg>
    @endif
    <div class="container">
