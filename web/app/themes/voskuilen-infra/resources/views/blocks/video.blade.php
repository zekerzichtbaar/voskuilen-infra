        ...
        <div class="flex justify-center items-center">
            <div class="relative w-full h-full">
                <div class="z-30 absolute inset-0 flex items-center justify-center">
                    <div id="playBtn" class="border-4 border-white p-4">
                ...
                <div class="hidden controls">
                    <div id="togglePlayBtn" class="bg-primary p-4 absolute -bottom-14 right-0">
                    ...
                    <div id="toggleAudioBtn" class="bg-primary p-4 absolute -bottom-14 right-14">
