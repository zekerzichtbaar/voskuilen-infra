<article @php(post_class('relative w-full h-full overflow-hidden group min-h-[500px]'))>
  <a href="{{ get_permalink() }}" class="flex flex-col absolute inset-0 w-full h-full">
    <div class="relative flex p-10 h-full">
    ...
    <div class="relative bg-white text-black p-10">
      <h3 class="font-semibold mt-auto mb-6">{!! $title !!}</h3>
