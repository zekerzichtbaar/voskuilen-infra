...
domReady(async () => {
  ...
  $('#menuBtn').on('click', function() {
    ...
    $('#menuScreen').toggleClass('-translate-y-full opacity-0 collapsed');
  ...
  $('#menu-highlighted-wrapper li').hover(
    function () {
    ...
    function () {
      var menuId = $('#menu-highlighted-wrapper li.current_page_item').prop('id');
      $('.menu-image').removeClass('active');
      $(`.menu-image[data-id=${menuId}]`).addClass('active');
    }
  );
